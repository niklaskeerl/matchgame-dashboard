// Added custom code at highlighted comment, otherwise code taken from: https://kozea.github.io/pygal.js/2.0.x/pygal-tooltips.min.js
(function() {
  ...
  init = function(ctx) {
    ...
    tooltip = function(el) {
      ...
      try{
        // Remove image element if it existed before
        document.getElementById("tooltip-img").remove()
      }
      catch(error){
      }
      // Create new svg image element and add it to the svg dynamically
      var svgimg = document.createElementNS('http://www.w3.org/2000/svg','image');
      svgimg.setAttributeNS(null,'height','105');
      svgimg.setAttributeNS(null,'width','105');
      svgimg.setAttribute('id','tooltip-img');
      svgimg.setAttributeNS('http://www.w3.org/1999/xlink','href', baseURL + "/static/img/" + x_label + ".png");
      svgimg.setAttributeNS(null,'x','0');
      svgimg.setAttributeNS(null,'y','200');
      svgimg.setAttributeNS(null, 'visibility', 'visible');
      document.children[0].append(svgimg);
